...
namespace DLLsSosPernambucanas.Infrastructure
{
    public class Utilidades
    {
        ...
        public static void EnviaEmailRecuperaSenha(string emailUsuario, string urlRecuperaSenha)
        {
            using (MailMessage mailMessage = new MailMessage("sospernambucan4s@gmail.com", emailUsuario))
            {
        ...
        {
            // PROTOCOLO ESTÁ SENDO INCLUÍDO DE FORMA FIXA NO LINK -> http
            ...
            string body =
                         "<html>" +
                            ...
                            "<body style='margin: 0;'>" +
                               ...
                               "</div>" +
                               "<div style='font-family: Verdana, Arial, Helvetica, sans-serif; width: 100%; padding: 2.222%;'>" +
                                   "<a style='background-color: #3f51b5; color: #fff; border-color: rgba(26,35,126,1); text-decoration: none; padding: 12px; font-family: Verdana, Arial, Helvetica, sans-serif' href='http://" + urlRecuperaSenha + "' target='_blank'>Redefinir Senha</a> " +
                               "</div>" +
                            "</body>" +
                         "</html>";
            return body;
